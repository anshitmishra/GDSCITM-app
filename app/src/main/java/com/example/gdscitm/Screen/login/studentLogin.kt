...
fun StudentLogin(navController : NavHostController) {
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(modifier = Modifier.padding(10.dp)) {
            Image(painter = painterResource(id = R.drawable.student_login_image), contentDescription = "login logo", modifier = Modifier
                .fillMaxWidth()
                .size(250.dp))
            Column(modifier = Modifier.padding(10.dp)) {
                ...
                Text(text = "Student Login", fontWeight = FontWeight.SemiBold, fontFamily = FontFamily(Font(R.font.ubuntu_bold)), fontSize = 30.sp, modifier = Modifier.padding(horizontal = 5.dp,vertical = 10.dp))
...
@Composable
fun preStudentlogin() {
    StudentLogin(navController = rememberNavController())
}